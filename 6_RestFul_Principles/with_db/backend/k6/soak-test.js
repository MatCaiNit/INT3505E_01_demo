...
export let options = {
  stages: [
    { duration: "5m", target: 100 },  // ramp-up từ từ
    { duration: "3h", target: 100 },  // duy trì load ổn định
    { duration: "5m", target: 0 },    // ramp-down
  ],
  thresholds: {
    http_req_duration: ["p(95)<2000"], // thời gian phản hồi chấp nhận
    http_req_failed: ["rate<0.01"],     // chấp nhận <1% request fail
  },
};
